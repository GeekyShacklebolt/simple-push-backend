...
class WebPushClientTest(TestCase):
    ...
    @patch("apps.notifications.services.webpush_client.webpush")
    ...
    @patch("apps.notifications.services.webpush_client.webpush", side_effect=WebPushException(message="Error!"))
