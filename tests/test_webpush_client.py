...
from apps.notifications.webpush_exceptions import WebPushRequestException
...
class WebPushClientTest(TestCase):
    ...
    def setUp(self):
        self.webpush_client_obj = WebPushClient(
    ...
    @patch("apps.notifications.webpush_client.webpush")
    ...
    @patch("apps.notifications.webpush_client.webpush", side_effect=WebPushException(message="Error!"))
